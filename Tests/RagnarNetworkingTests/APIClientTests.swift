...
struct APIClientTests {
    ...
    // MARK: 15. Cancelling the caller's task during transport throws promptly
    ...
    // MARK: 16. Cancelling the caller's task during refresh throws promptly and does not retry
