...
A modern, type-safe Swift networking library that provides a simple and structured approach to making network requests.

## Overview

RagnarNetworking eliminates boilerplate and provides compile-time safety for your API interactions. By defining your endpoints as `Interface` types, you get automatic request construction, response handling, and error management with full type safety.

### Key Features

- **Type-Safe Endpoints** - Define your API endpoints as Swift types with compile-time guarantees
...
- **Powerful Error Inspection** - Rich error types with helpers for debugging
- **Interceptor Support** - Token refresh, exponential backoff, and custom request/response handling
- **Fully Tested** - Comprehensive test coverage with no external network dependencies
...
*(Placeholder for interceptor documentation)*

RagnarNetworking supports request and response interceptors for:
- Automatic token refresh
- Exponential backoff retry logic
- Request modification and logging
- Custom error handling

### Socket Support

*(Placeholder for socket documentation)*

Built-in WebSocket support for real-time communication.

### Request Services

*(Placeholder for request service documentation)*

Simplified request execution with `RequestService` and `InterceptableRequestService`.

### Logging

*(Placeholder for logging documentation)*

Integrated logging service for debugging and monitoring.
